...
// Quantidade maxima de iteracoes anteriosres que serao salvas, TALVEZ PRECISE
// SER DINAMICO! A CONTRIBUICAO IDEAL DE FRAMES ANTERIORES DEPENDE DA CAMERA E
// DE OUTROS FATORES
...
BETTER_ENUM(Color, int, INVALID = 0, ORANGE, BLUE, YELLOW, RED, GREEN, PINK,
            CYAN, PURPLE, BROWN);
...
static constexpr std::initializer_list<Color::_enumerated> ALL_COLORS{
    ...
    Color::PINK,   Color::CYAN, Color::PURPLE, Color::BROWN};
...
static constexpr std::initializer_list<Color::_enumerated> ROBOT_COLORS{
    ...
    Color::CYAN, Color::PURPLE, Color::BROWN};
